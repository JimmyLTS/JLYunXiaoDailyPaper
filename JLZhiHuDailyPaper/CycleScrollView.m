...
@property (nonatomic, strong) NSMutableArray *contenViews;
...
- (void)configContentViews {
    ...
    NSInteger counter = 0;
    for (UIView *contentView in self.contenViews) {
...
- (void)setScrollViewContentDataSource {
    ...
    if (self.contenViews == nil) {
        self.contenViews = [@[] mutableCopy];
    }
    [self.contenViews removeAllObjects];
    
    if (self.fetchContentViewAtIndex) {
        [self.contenViews addObject:self.fetchContentViewAtIndex(previousPageIndex)];
        [self.contenViews addObject:self.fetchContentViewAtIndex(_currentPageIndex)];
        [self.contenViews addObject:self.fetchContentViewAtIndex(rearPageIndex)];
    }
}
