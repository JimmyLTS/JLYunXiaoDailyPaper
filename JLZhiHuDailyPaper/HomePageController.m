...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    SectionModel *detailStory = self.stories[section];
    headerView.date = detailStory.date;
...
- (void)setUpDataSource {
    ...
    self.newsArrayDataSource = [[ArrayDataSource alloc] initWithItems:self.stories cellIdentifier:homeCellIdentifier configureCellBlock:configureCell];
...
- (CycleView *)headerView{
    if (_headerView == nil) {
        _headerView = [CycleView attchToView:self.view observeScrollView:self.tableView];
