...
typedef NS_OPTIONS(NSUInteger, NavigationTag) {
    NavigationTagBack = 1 << 0,     //1
    NavigationTagNext = 1 << 1,     //2
    NavigationTagVote = 1 << 2,     //4
    NavigationTagShare = 1 << 3,    //8
    NavigationTagComment = 1 << 4,  //16
    
};

static CGFloat const animationDuration = 0.2f;

@interface ContainerController ()<NewsNavigationDelegate,DetailViewControllerDelegate>
